...
SUMOPOD_MODELS: List[ModelInfo] = [
    ModelInfo(
        id="qwen3.6-flash",
        name="Qwen3.6 Flash (Alibaba)",
        supports_image=False,
        supports_video=False,
        probe_source="documentation",
    ),
    ...
    ModelInfo(
        ...
        name="Gemini 3 Flash Preview (Google)",
        supports_image=True,
        supports_video=True,
        probe_source="documentation",
    ),
    ...
    ModelInfo(
        ...
        name="Gemini 3.1 Flash Lite Preview (Google)",
        supports_image=True,
        supports_video=True,
        probe_source="documentation",
    ),
...
PROVIDER_SUMOPOD = OpenAIProvider(
    id="sumopod",
    name="Sumopod AI",
...
class ProviderManager:  # pylint: disable=too-many-public-methods
    ...
    def _init_builtins(self):
        self._add_builtin(PROVIDER_SUMOPOD)
